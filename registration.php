...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $statement->execute([
            ...
            ':cust_cname' => $_POST['cust_cname'] ?? '', // Use empty string if not provided
            ...
            ':cust_b_name' => '', // Default empty values for billing fields
            ':cust_b_cname' => '',
            ':cust_b_phone' => '',
            ':cust_b_country' => 0,
            ':cust_b_address' => '',
            ...
            ':cust_b_state' => '',
            ':cust_b_zip' => '',
            ':cust_s_name' => '', // Default empty values for shipping fields
            ':cust_s_cname' => '',
            ':cust_s_phone' => '',
            ':cust_s_country' => 0,
            ':cust_s_address' => '',
            ...
            ':cust_s_state' => '',
            ':cust_s_zip' => '',
            ':cust_password' => $hashed_password, // Use the hashed password
            ':cust_token' => $token,
            ':cust_datetime' => $cust_datetime,
            ':cust_timestamp' => $cust_timestamp,
            ':cust_status' => 1 // Default status (active)
        ]);
